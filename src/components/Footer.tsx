    ...
    <footer style={{ background: "#1E1B4B" }}>
      <div className="mx-auto max-w-[1400px] px-6 py-16 md:px-12">
        <div className="grid gap-10 md:grid-cols-4">
          <div>
            <img src="/fluario-icon.png" alt="Fluario" style={{ height: 56 }} />
            ...
            <div className="mt-5 flex flex-wrap gap-4 font-mono-caps">
              <a href="#" className={linkCls}>Instagram</a>
              <a href="#" className={linkCls}>TikTok</a>
              <a href="#" className={linkCls}>Facebook</a>
              <a href="#" className={linkCls}>LinkedIn</a>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="#booking" className={linkCls}>Book a Call</a>
              <a href="mailto:hello@fluario.com" className={linkCls}>hello@fluario.com</a>
            </div>
          </div>
          <div>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-[rgba(107,111,212,0.2)] pt-6 text-xs md:flex-row md:items-center md:justify-between font-mono-caps">
          ...
          <span><a href="#" className={linkCls + " inline"}>Privacy Policy</a> | <a href="#" className={linkCls + " inline"}>Terms of Service</a></span>
        </div>
      </div>
    </footer>
  );
